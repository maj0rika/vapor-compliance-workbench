...
| Generated component Canvas | user-verifiable | Canvas tab loads `/api/deepseek/preview` from an isolated loopback origin, Vite transforms the generated TSX entry, iframe posts ready/error, and iframe DOM exposes the generated button in E2E | Complex prop controls still need a dedicated Props panel. |
